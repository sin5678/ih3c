...
std::wstring string_utils::mbstowcs(const string& r)
{
    wstring result;
...
std::string string_utils::wcstombs(const wstring& r)
{
    string result;
...
std::wstring string_utils::utf8towcs(const std::string& utf8str) /*throw(std::runtime_error)*/
{
    std::wstring result;
...
std::string string_utils::wcstoutf8(const std::wstring& wstr)
{
    std::string result;
    result.reserve(wstr.size()*3/2+1);
...
//
//std::string string_utils::filenamize(const std::string& str, char replace)
//{
...
//}
//
//std::wstring string_utils::filenamize(const std::wstring& str, wchar_t replace)
//{
